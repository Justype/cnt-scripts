...
POSIT_R_VERSIONS="4.6.0 4.5.3 4.5.2 4.5.1 4.5.0 4.4.3 4.4.2 4.4.1 4.4.0 4.3.3 4.3.2 4.3.1 4.3.0 4.2.3 4.2.2 4.2.1 4.2.0 4.1.3 4.1.2 4.1.1 4.1.0 4.0.5 4.0.4 4.0.3 4.0.2 4.0.1 4.0.0"
CONDA_PYTHON_VERSIONS="3.14.5 3.14.4 3.14.3 3.14.2 3.14.1 3.14.0 3.13.13 3.13.12 3.13.11 3.13.10 3.13.9 3.13.8 3.13.7 3.13.5 3.13.3 3.13.2 3.13.1 3.13.0 3.12.13 3.12.12 3.12.11 3.12.10 3.12.9 3.12.8 3.12.7 3.12.6 3.12.5 3.12.4 3.12.3 3.12.2 3.12.1 3.12.0 3.11.15 3.11.14 3.11.13 3.11.12 3.11.11 3.11.10 3.11.9 3.11.8 3.11.7 3.11.6 3.11.5 3.11.4 3.11.3 3.11.2 3.11.1 3.11.0 3.10.20 3.10.19 3.10.18 3.10.17 3.10.16 3.10.15 3.10.14 3.10.13 3.10.12 3.10.11 3.10.10 3.10.9 3.10.8 3.10.7 3.10.6 3.10.5 3.10.4 3.10.2 3.10.1 3.10.0 3.9.23 3.9.22 3.9.21 3.9.20 3.9.19 3.9.18 3.9.17 3.9.16 3.9.15 3.9.14 3.9.13 3.9.12 3.9.10 3.9.9 3.9.7 3.9.6 3.9.5 3.9.4 3.9.2 3.9.1 3.9.0"
CONDA_R_VERSIONS="4.6.0 4.5.3 4.5.2 4.5.1 4.4.3 4.4.2 4.4.1 4.4.0 4.3.3 4.3.2 4.3.1 4.3.0 4.2.3 4.2.2 4.2.1 4.2.0 4.1.3 4.1.2 4.1.1 4.1.0 4.0.5 4.0.3 4.0.2 4.0.1 4.0.0"
...
read_job_state() {
    ...
    output=$(timeout "${SCHEDULER_TIMEOUT:-5}" bjobs -noheader -o stat "$JOB_ID" 2>/dev/null); exit_code=$?
    ...
    case "$status" in
        PEND) return 1 ;;
        RUN)
            [ -z "$NODE" ] && NODE=$(timeout "${SCHEDULER_TIMEOUT:-5}" bjobs -noheader -o exec_host "$JOB_ID" 2>/dev/null | awk '{print $1}' | cut -d'/' -f1)
            return 2 ;;
        *) return 3 ;;
    esac
}
...
wait_for_job() {
    ...
    NODE=$(timeout "${SCHEDULER_TIMEOUT:-5}" bjobs -noheader -o exec_host "$job_id" 2>/dev/null | awk '{print $1}' | cut -d'/' -f1)
    if [ -z "$NODE" ]; then
