#!/usr/bin/env python3
"""
Query Docker Hub and GitHub to update ubuntu24/*.def files

- R related => query posit/r-base tags
    - For tags like 4.4.3-noble-{arch} => updates #PL:version: in posit-r.def
    python3 build-scripts/ubuntu24/auto.py  # to update posit-r.def
